...
C<karasuma_id> data type for the Dongry database handler module.
...
i.e. a 128-bit byte sequence, or the C<NULL> value.  If the input is a
Karasuma ID, corresponding L<Karasuma::ID> object is returned.
Otherwise the C<undef> value is returned.

Please note that the C<undef> value does not roundtrip.
