...
C<karasuma_id> and C<karasuma_id_nullable> data types for the Dongry
...
C<karasuma_id_nullable> data types never generate the SQL C<NULL>
value.
...
is C<karasuma_id_nullable> and the input is the void ID, the C<undef>
...
C<karasuma_id_nullable> data type.
